...
/** 정책 기본값 — RPC settings 가 비정상일 때만 (0008 campaign_card 의 coalesce 기본값과 동일) */
export const DEFAULT_SETTINGS: CampaignCard["settings"] = { clear_days: 21, link_protect_days: 7, home_feature_days: 7 };
 ...
 * 상대 경로는 web/public/assets/ 로 복사된 파일을 가리키도록 '/' 를 붙인다.
 */
