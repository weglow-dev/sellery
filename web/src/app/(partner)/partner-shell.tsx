...
/**
 * 파트너 콘솔 셸 (docs/inf-console-plan.md §2.1 partner-shell): 상단 바(워드마크 + 콘솔 라벨 + 우측 자리) ·
 ...
 *
 * 우측 자리(`.console-bar-right`)는 2단계에서 활동명 · 등급 · 🥬 잔액이 들어온다 — 지금은 비어 있다.
 */
...
/* 탭 href 는 접두 없는 콘솔 경로. 아직 없는 페이지(상품·캠페인·매출·내 정보)도 disabled 로 두지 않고 링크를 유지한다 —
  ...
  return (
    <>
      ...
      <header className="console-bar">
        ...
        <div className="console-bar-right" aria-hidden="true" />
      </header>
