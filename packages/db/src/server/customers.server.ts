/**
 * customers 행 보장 — web/src/lib/customers.ts 그대로 (계약 docs/app-plan.md §10.0 · §4.1).
 *
...
export function parseShipping(json: unknown): Shipping | null {
...
export async function ensureCustomer(admin: Admin, user: User): Promise<CustomerRef> {
