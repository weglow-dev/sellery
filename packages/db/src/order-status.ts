...
/** platform_settings.clear_days 를 못 읽을 때의 기본값 — 정책 숫자의 단일 소스 `@sellery/core/constants` CLEAR_DAYS(21 · 0008 coalesce 기본값과 동일) */
export const DEFAULT_CLEAR_DAYS: number = CLEAR_DAYS;
