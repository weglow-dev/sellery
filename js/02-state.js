...
const SHOP={
  seller:[
    ...
    {id:'homefeature',name:'고객 홈 상단 노출 (7일)',price:3,desc:'sellery.life 고객 홈 "진행 중인 판매" 최상단에 내 진행 중·예정 판매 고정 + 추천 뱃지'},
  ...
  brand:[
    ...
    {id:'homefeature',name:'고객 홈 상단 노출 (7일)',price:5,desc:'sellery.life 고객 홈 "진행 중인 판매" 최상단에 내 상품의 진행 중·예정 판매 고정 + 추천 뱃지'},
