...
├─ lib/demo.ts                      NEW   DEMO_PATHS = ['/demo','/demo-login','/demo-products','/demo-orders','/demo-cs','/demo-sales','/demo-settle','/demo-my','/camps','/dm','/gallery','/shop','/c','/s'] · demoPathOf(core 화면 경로 → /demo-*) · isDemoPath · demoEnabled (influencer 와 동일 시그니처, 1단계 적용)
