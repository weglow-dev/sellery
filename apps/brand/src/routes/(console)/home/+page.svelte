<script lang="ts">
	 ...
	 * 프로토타입 js/40-brand.js vBrandHome 의 "승인·처리 대기" · "진행 중 · 확정 판매" · "상품 현황" 카드 문구를 그대로 — 매출 KPI(내 장부) · 등급 카드 · 인플루언서 찾기는 5·6단계.
	...
	<div class="listcard console-rows">
		...
		{#if data.clearing}
			<a href={`${data.campaignsPath}?f=done`} class="rowitem">
				...
				<div class="grow"><div class="nm">교환·환불 기간 {data.clearing}건</div><div class="sub">종료 후 21일이 지나면 정산돼요 — 정산 명세는 5단계</div></div>
