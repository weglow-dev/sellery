<script lang="ts">
	/** 이용 정지 안내 카드 — web influencer/suspended/page.tsx 1:1. 폼 없음(고객센터 이메일 안내) · 로그아웃만 (콘솔 전용 auth/signout, 결정 15). */
...
<div class="console-auth">
	<section class="card static">
		...
		<p class="meta"><b>{data.name}</b> 님의 인플루언서 계정은 현재 이용이 정지된 상태예요. 진행 중이던 캠페인·정산은 셀러리 운영팀이 별도로 안내드립니다.</p>
